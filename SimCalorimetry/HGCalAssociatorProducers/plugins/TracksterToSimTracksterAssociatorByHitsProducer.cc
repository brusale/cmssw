...
TracksterToSimTracksterAssociatorByHitsProducer<HIT>::TracksterToSimTracksterAssociatorByHitsProducer(
...
template <typename HIT>
void TracksterToSimTracksterAssociatorByHitsProducer<HIT>::produce(edm::StreamID,
                                                                   edm::Event& iEvent,
