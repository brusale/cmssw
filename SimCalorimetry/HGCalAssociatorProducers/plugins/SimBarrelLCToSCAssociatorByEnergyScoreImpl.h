...
class SimBarrelLCToSCAssociatorByEnergyScoreImpl : public hgcal::LayerClusterToSimClusterAssociatorBaseImpl {
public:
  explicit SimBarrelLCToSCAssociatorByEnergyScoreImpl(edm::EDProductGetter const &,
                                             bool,
