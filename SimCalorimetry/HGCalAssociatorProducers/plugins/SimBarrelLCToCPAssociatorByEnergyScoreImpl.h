...
class SimBarrelLCToCPAssociatorByEnergyScoreImpl : public hgcal::LayerClusterToCaloParticleAssociatorBaseImpl {
  public:
    explicit SimBarrelLCToCPAssociatorByEnergyScoreImpl(edm::EDProductGetter const &,
					       bool,
					       std::shared_ptr<hgcal::RecHitTools>,
					       const std::unordered_map<DetId, float> *);
  ...
  private:
    ...
    const std::unordered_map<DetId, float> *hitMap_;
    unsigned layers_;
