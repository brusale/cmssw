...
class SimBarrelLCToCPAssociatorEDProducer : public edm::global::EDProducer<> {
public:
  explicit SimBarrelLCToCPAssociatorEDProducer(const edm::ParameterSet &);
  ~SimBarrelLCToCPAssociatorEDProducer() override;
...
SimBarrelLCToCPAssociatorEDProducer::SimBarrelLCToCPAssociatorEDProducer(const edm::ParameterSet &pset) {
...
SimBarrelLCToCPAssociatorEDProducer::~SimBarrelLCToCPAssociatorEDProducer() {}
...
void SimBarrelLCToCPAssociatorEDProducer::produce(edm::StreamID, edm::Event &iEvent, const edm::EventSetup &iSetup) const {
  using namespace edm;
...
DEFINE_FWK_MODULE(SimBarrelLCToCPAssociatorEDProducer);
