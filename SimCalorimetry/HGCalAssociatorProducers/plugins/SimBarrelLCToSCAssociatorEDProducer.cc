...
class SimBarrelLCToSCAssociatorEDProducer : public edm::global::EDProducer<> {
  public:
    explicit SimBarrelLCToSCAssociatorEDProducer(const edm::ParameterSet&);
    ~SimBarrelLCToSCAssociatorEDProducer() override;
...
SimBarrelLCToSCAssociatorEDProducer::SimBarrelLCToSCAssociatorEDProducer(const edm::ParameterSet& pset) {
...
SimBarrelLCToSCAssociatorEDProducer::~SimBarrelLCToSCAssociatorEDProducer() {}

void SimBarrelLCToSCAssociatorEDProducer::produce(edm::StreamID, edm::Event &iEvent, const edm::EventSetup &iSetup) const {
  using namespace edm;
...
DEFINE_FWK_MODULE(SimBarrelLCToSCAssociatorEDProducer);
