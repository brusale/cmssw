...
from SimCalorimetry.HGCalAssociatorProducers.SimBarrelLCToCPAssociation_cfi import simBarrelLayerClusterCaloParticleAssociation
from SimCalorimetry.HGCalAssociatorProducers.SimBarrelLCToSCAssociation_cfi import simBarrelLayerClusterSimClusterAssociation
...
simBarrelValidator = DQMEDAnalyzer(
    "SimBarrelValidator",
    ...
    label_lcl = simBarrelLayerClusterCaloParticleAssociation.label_lc,
    ...
    associator = cms.untracked.InputTag("simBarrelLayerClusterCaloParticleAssociationProducer"),

    associatorSim = cms.untracked.InputTag("simBarrelLayerClusterSimClusterAssociationProducer"),
    ...
    label_layerClusterPlots = cms.InputTag("simBarrelLayerClusters"),
    ...
    label_cp_effic = simBarrelLayerClusterCaloParticleAssociation.label_cp,
    label_cp_fake = cms.InputTag("mix","MergedCaloTruth"),
    #simClusters
    label_scl = simBarrelLayerClusterSimClusterAssociation.label_scl,
    ...
    dirName = cms.string('CLUE-simBarrel/BarrelValidator/')

)

from Configuration.ProcessModifiers.premix_stage2_cff import premix_stage2
premix_stage2.toModify(simBarrelValidator,
