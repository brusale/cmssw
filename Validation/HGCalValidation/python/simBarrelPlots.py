...
from Validation.HGCalValidation.SimPostProcessorBarrel_cfi import lcToCP_linking#, simDict, variables

barrelVal_dqm = "DQMData/Run 1/CLUE-simBarrel/Run summary/BarrelValidator/"
geometryscenario = 88
...
def append_barrelLayerClustersPlots(collection = simBarrelValidator.label_layerClusterPlots._InputTag__moduleLabel, name_collection = layerClustersLabel, extended = False):
