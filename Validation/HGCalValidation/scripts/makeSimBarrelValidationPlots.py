...
import Validation.HGCalValidation.simBarrelPlots as simBarrelPlots
import Validation.RecoTrack.plotting.plotting as plotting

simClustersIters = [
    simBarrelValidator.label_SimClustersLevel._InputTag__moduleLabel, "ticlSimTracksters"]
...
def main(opts):
    ...
    # layerClusters
    def plot_LC():
        barrellayclus = [simBarrelPlots.barrelLayerClustersPlotter]
        simBarrelPlots.append_barrelLayerClustersPlots(
            simBarrelValidator.label_layerClusterPlots._InputTag__moduleLabel, "Layer Clusters", extendedFlag)
