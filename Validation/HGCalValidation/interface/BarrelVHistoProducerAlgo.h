...
struct BarrelVHistoProducerAlgoHistograms {
  ...
  std::unordered_map<int, dqm::reco::MonitorElement*> h_num_caloparticle_energy_perlayer;
  ...
  std::unordered_map<int, dqm::reco::MonitorElement*> h_numDup_caloparticle_energy_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_numDup_caloparticle_pt_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_denom_caloparticle_phi_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_denom_caloparticle_energy_perlayer;
  ...
  std::unordered_map<int, dqm::reco::MonitorElement*> h_num_layercl_energy_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_numMerge_layercl_phi_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_numMerge_layercl_energy_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_denom_layercl_phi_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_denom_layercl_energy_perlayer;
  std::unordered_map<int, dqm::reco::MonitorElement*> h_denom_layercl_pt_perlayer;
  ...
  std::unordered_map<std::string, dqm::reco::MonitorElement*> h_distancetoseedcell_perlayer;
  std::unordered_map<std::string, dqm::reco::MonitorElement*> h_distancetoseedcell_perlayer_eneweighted;
  std::unordered_map<std::string, dqm::reco::MonitorElement*> h_distancetomaxcell_perlayer;
  std::unordered_map<std::string, dqm::reco::MonitorElement*> h_distancetomaxcell_perlayer_eneweighted;
  std::unordered_map<std::string, dqm::reco::MonitorElement*> h_distancebetseedandmaxcell_perlayer;
  std::unordered_map<std::string, dqm::reco::MonitorElement*>
      h_distancebetseedandmaxcellvsclusterenergy_perlayer;
...
public:
  ...
  double distanceetaphi2(const double eta1, const double phi1, const double eta2, const double phi2) const;
...
private:
  ...
  double minDisToSeedperlayer_, maxDisToSeedperlayer_;
  int nintDisToSeedperlayer_;
  double minDisToSeedperlayerenewei_, maxDisToSeedperlayerenewei_;
  int nintDisToSeedperlayerenewei_;
  double minDisToMaxperlayer_, maxDisToMaxperlayer_;
  int nintDisToMaxperlayer_;
  double minDisToMaxperlayerenewei_, maxDisToMaxperlayerenewei_;
  int nintDisToMaxperlayerenewei_;
  double minDisSeedToMaxperlayer_, maxDisSeedToMaxperlayer_;
  int nintDisSeedToMaxperlayer_;
  double minClEneperlayer_, maxClEneperlayer_;
  int nintClEneperlayer_;
