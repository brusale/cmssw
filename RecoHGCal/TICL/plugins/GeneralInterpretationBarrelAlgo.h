#ifndef RecoHGCal_TICL_GeneralInterpretationBarrelAlgo_H_
#define RecoHGCal_TICL_GeneralInterpretationBarrelAlgo_H_
...
namespace ticl {
  ...
  class GeneralInterpretationBarrelAlgo : public TICLInterpretationAlgoBase<reco::Track> {
  public:
    GeneralInterpretationBarrelAlgo(const edm::ParameterSet &conf, edm::ConsumesCollector iC);

    ~GeneralInterpretationBarrelAlgo() override;
